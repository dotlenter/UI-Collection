...
class ScheduleItem extends StatelessWidget {
                ...
                FittedBox(
                  child: Text(
                    ...
                    style: TextStyle(
                        ...
                        fontSize: 16,
                        color:
                            _getItemColor(schedule.dateTime, schedule.status)),
                  ),
                ),
                Text(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _getStatusDisplay(schedule.status),
              ],
            ),
          )
        ],
  ...
  _getItemColor(DateTime dateTime, String status) {
  ...
  _getStatusDisplay(String status) {
    if (status != "Normal Shift" && status != "Rest Day") {
      return Row(
        children: [
          Icon(
