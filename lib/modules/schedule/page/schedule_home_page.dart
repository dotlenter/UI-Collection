        ...
        Container(
          child: Container(
            ...
            decoration: BoxDecoration(
                border:
                    Border(top: BorderSide(color: CommonColors.neutral[30]!))),
            child:
              ...
              Row(
                ...
                children: const [
                  ClockingWidget(title: "Clock In", icon: Icons.login),
                  ClockingWidget(title: "Clock Out", icon: Icons.logout)
                ],
              )
            ]),
          ),
